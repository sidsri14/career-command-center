      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-1 w-full">
        ...
        <div className="flex border-b border-white/10 gap-2 mb-8 overflow-x-auto pb-2 scrollbar-none">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition whitespace-nowrap ${activeTab === 'target-companies'
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition whitespace-nowrap ${activeTab === 'reflections'
                ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-600/20'
                : 'glass-card text-slate-400 hover:text-white hover:bg-white/5'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition whitespace-nowrap ${activeTab === 'portfolio-gallery'
                ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-600/20'
                : 'glass-card text-slate-400 hover:text-white hover:bg-white/5'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition whitespace-nowrap ${activeTab === 'hackathons'
                ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-600/20'
                : 'glass-card text-slate-400 hover:text-white hover:bg-white/5'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition whitespace-nowrap ${activeTab === 'resume-ats'
                ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-600/20'
                : 'glass-card text-slate-400 hover:text-white hover:bg-white/5'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition whitespace-nowrap ${activeTab === 'outreach-studio'
                ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-600/20'
                : 'glass-card text-slate-400 hover:text-white hover:bg-white/5'
              }`}
          >
            ...
            <div className="space-y-4">
              ...
              {TARGET_COMPANIES.map((company) => (
                <div
                  ...
                  className={`p-5 rounded-2xl cursor-pointer transition border ${selectedCompany.id === company.id
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${company.hiringStatus === 'URGENT_HIRING'
              ...
              <div className="space-y-4">
                ...
                {COMPANY_REFLECTIONS.map((refl) => (
                  <div
                    ...
                    className={`p-5 rounded-2xl cursor-pointer transition border ${selectedReflection.id === refl.id
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${refl.statusTag === 'PIVOTED_TO_WIN'
                          ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30'
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <button
                            ...
                            className={`w-6 h-6 rounded-lg flex items-center justify-center border transition ${isMastered
